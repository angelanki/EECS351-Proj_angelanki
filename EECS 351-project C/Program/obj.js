...
function initVertexBuffers(gl, program) {
  ...
  o.vertexBuffer = initArrayBufferForLaterUse(gl, program.a_Position, 3, gl.FLOAT); 
...
// 描画関数
function drawObj(gl, program, angle, viewProjMatrix, model) {
...
MTLDoc.prototype.parseRGB = function(sp, name) {
  ...
  var g = sp.getFloat();
  var b = sp.getFloat();
  return (new Material_obj(name, r, g, b, 1));
}

//------------------------------------------------------------------------------
// Material Object
//------------------------------------------------------------------------------
var Material_obj = function(name, r, g, b, a) {
  this.name = name;
